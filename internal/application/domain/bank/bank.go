...
type TrasferTransaction struct {
...
var ErrTransferTransactionPair = errors.New("can't create transfer transaction pair possibly insufficent fund on source account")
